    ...
    cards = [
        { Name: 'Fool', img: "./untitled folder/sm_RWSa-T-00.png", text: 'this is the description of the card'},
        { Name: 'The Magician', img: './untitled folder/sm_RWSa-T-01.png', text: 'this is the description of the card' },
        { Name: 'The High Priestess',img: "./untitled folder/sm_RWSa-T-02.png", text: 'this is the description of the card' },
        { Name: 'The Emperor',img: "./untitled folder/sm_RWSa-T-03.png", text: 'this is the description of the card' }, 
        { Name: 'The Empress',img: "./untitled folder/sm_RWSa-T-04.png", text: 'this is the description of the card' },
        { Name: 'The Heirophant',img: "./untitled folder/sm_RWSa-T-05.png", text: 'this is the description of the card' },
        { Name: 'The Lovers',img: "./untitled folder/sm_RWSa-T-06.png", text: 'this is the description of the card' },
        { Name: 'The Chariot',img: "./untitled folder/sm_RWSa-T-07.png", text: 'this is the description of the card' },
        { Name: 'Strength',img: "./untitled folder/sm_RWSa-T-08.png", text: 'this is the description of the card' },
        { Name: 'The Hermit',img: "./untitled folder/sm_RWSa-T-09.png", text: 'this is the description of the card' },
        { Name: 'Judgement',img: "./untitled folder/sm_RWSa-T-10.png", text: 'this is the description of the card' },
        { Name: 'The Hanged Man',img: "./untitled folder/sm_RWSa-T-11.png", text: 'this is the description of the card' },
        { Name: 'The Wheel of Fortune',img: "./untitled folder/sm_RWSa-T-12.png", text: 'this is the description of the card' },
        { Name: 'Death',img: "./untitled folder/sm_RWSa-T-13.png", text: 'this is the description of the card' },
        { Name: 'Temprence',img: "./untitled folder/sm_RWSa-T-14.png", text: 'this is the description of the card' }, 
        { Name: 'The Devil',img: "./untitled folder/sm_RWSa-T-15.png", text: 'this is the description of the card' },
        { Name: 'The Tower',img: "./untitled folder/sm_RWSa-T-16.png", text: 'this is the description of the card' },
        { Name: 'The Star',img: "./untitled folder/sm_RWSa-T-17.png", text: 'this is the description of the card' },
        { Name: 'The Moon',img: "./untitled folder/sm_RWSa-T-18.png", text: 'this is the description of the card' },
        { Name: 'The Sun',img: "./untitled folder/sm_RWSa-T-19.png", text: 'this is the description of the card' },
        { Name: 'Judgement',img: "./untitled folder/sm_RWSa-T-20.png", text: 'this is the description of the card'},
        { Name: 'The World',img: "./untitled folder/sm_RWSa-T-21.png", text: 'this is the description of the card' },
        ...
        { Name: 'King of Pentacles',img: "./untitled folder/sm_RWSa-KI-00.png", text: 'this is the description of the card' },
        ...
        { Name: 'Ten of Pentacles',img: "./untitled folder/sm_RWSa-S-10.png", text: 'this is the description of the card' },
        ...
        { Name: 'Six of Wands',img: "./untitled folder/sm_RWSa-W-08.png", text: 'this is the description of the card' },
        { Name: 'Six of Cups',img: "./untitled folder/sm_RWSa-C-08.png", text: 'this is the description of the card' },
        { Name: 'Six of Pentacles',img: "./untitled folder/sm_RWSa-P-08.png", text: 'this is the description of the card' },
        { Name: 'Six of Swords',img: "./untitled folder/sm_RWSa-S-08.png", text: 'this is the description of the card' },
        { Name: 'Five of Wands',img: "./untitled folder/sm_RWSa-W-07.png", text: 'this is the description of the card' },
        { Name: 'Five of Cups',img: "./untitled folder/sm_RWSa-C-07.png", text: 'this is the description of the card' },
        { Name: 'Five of Pentacles',img: "./untitled folder/sm_RWSa-P-07.png", text: 'this is the description of the card' },
        { Name: 'Five of Swords',img: "./untitled folder/sm_RWSa-S-07.png", text: 'this is the description of the card' },
